...
for (i in seq_len(nrow(lobbys))) {
  ...
  body <- c(
    ...
    "      showcase = tags$div(",
    "        style = 'background: white; border-radius: 50%; width: 60px; height: 60px; display: flex; align-items: center; justify-content: center;',",
    "        fa('democrat', fill = 'blue', height = '3em')",
    "      ),",
    "      theme = 'primary',",
    ...
    "      showcase = tags$div(",
    "        style = 'background: white; border-radius: 50%; width: 60px; height: 60px; display: flex; align-items: center; justify-content: center;',",
    "        fa('republican', fill = 'red', height = '3em')",
    "      ),",
    "      theme = 'danger',",
